...
class CrossDatasetValidator:
    ...
    def load_and_preprocess_botiot(self, dataset_path):
        """Load and preprocess BoT-IoT dataset"""
    ...
    def evaluate_cross_dataset_performance(self, test_df):
        ...
        try:
            ...
            # Calculate initial metrics (if not already done by adaptive threshold)
            if not skip_metrics:
    ...
    def run_cross_dataset_validation_single_file(self, botiot_file_path):
        """Run cross-dataset validation on a single BoT-IoT file"""
    ...
    def run_cross_dataset_validation_directory(self, botiot_directory):
        """Run complete cross-dataset validation on all files in directory"""
        print("🌐 CROSS-DATASET VALIDATION STUDY")
        print("=" * 60)
